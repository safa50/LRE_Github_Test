param([string][Parameter(Mandatory=$true,Position=0,HelpMessage="The base of the LRE server URL. e.g. http(s)://mylreserver.mydomain.com:80")] $lreServer="https://lrefrademo.saas.microfocus.com/",
	  [string][Parameter(Mandatory=$true,Position=1,HelpMessage="the LRE user able to perform action on the lreproject")] $username="safa.dundar",
	  [string][Parameter(Mandatory=$true,Position=2,HelpMessage="the password of the lre user")] $password="Welcome1",
	  [string][Parameter(Mandatory=$true,Position=3,HelpMessage="the name of the domain in LRE (case sensitive)")] $domain="POC",
	  [string][Parameter(Mandatory=$true,Position=4,HelpMessage="the name of the project in LRE (case sensitive)")] $project="Afterburner_Jmeter",
	  [string][Parameter(Mandatory=$true,Position=5,HelpMessage="the full file name of the script compressed to zip file and accessible by powershell")] $filePath="C:\Users\demo\Desktop\JMeter\AOS Test_.zip",
	...
	and might be case sensitive and should contain the root subject). e.g. myscriptsfolder\mysubscriptsfolder\mysubsubscriptsfolder")] $lreScriptSubjectPath="Subject\PowershellTest_Safa",
	  ...
	  [string][Parameter(Mandatory=$false,Position=9,HelpMessage="relevant for multitenancy")] $tenant="4d9e8f34-6581-4e04-a9ac-2c5cbac051f5")

# Add the required assemblies
Add-Type -AssemblyName System.Net.Http

####### Define parameters (parametrized above) #########
# $lreServer = "https://lrefrademo.saas.microfocus.com/"
# $tenant = "4d9e8f34-6581-4e04-a9ac-2c5cbac051f5"
# $username = "safa.dundar"
# $password = "Welcome1"
# $domain = "POC"
# $project = "Afterburner_Jmeter"
# $filePath = "C:\Users\demo\Desktop\JMeter\AOS Test_.zip"
# $lreScriptSubjectPath = "Subject\PowershellTest_Safa"
